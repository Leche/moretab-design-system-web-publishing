...
find v2 -name "*.html" -exec sed -i '' 's|assets/ds.css"|assets/ds.css?v=23"|g; s|assets/ds.js"|assets/ds.js?v=23"|g; s|../assets/ds.css"|../assets/ds.css?v=23"|g; s|../assets/ds.js"|../assets/ds.js?v=23"|g' {} + && \
git add v2 && \
git commit -m "v2: Category cards redesign with Figma thumbnails (@3x PNG)" && \
git push
```
