...
find v2 -name "*.html" -exec sed -i '' 's|assets/ds.css"|assets/ds.css?v=5"|g; s|assets/ds.js"|assets/ds.js?v=5"|g; s|../assets/ds.css"|../assets/ds.css?v=5"|g; s|../assets/ds.js"|../assets/ds.js?v=5"|g' {} + && \
git add v2 && \
